 ...
 */
import flowistLogo from '@/assets/flowist-logo.png.asset.json';
...
export const CardBrandingFooter = ({
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', marginTop: '4px' }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
      <img src={flowistLogo.url} alt="Flowist" style={{ width: '20px', height: '20px', borderRadius: '4px', objectFit: 'cover' }} />
...
export const CardBrandingFooterLarge = ({
  ...
  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', marginTop: '40px' }}>
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
      <img src={flowistLogo.url} alt="Flowist" style={{ width: '48px', height: '48px', borderRadius: '12px' }} />
